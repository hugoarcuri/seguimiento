...
export function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b bg-background/80 shadow-[0_1px_2px_rgba(0,0,0,0.03)] backdrop-blur supports-[backdrop-filter]:bg-background/60">
