  ...
  },
  {
    ...
    guia: {
      ...
      puntosClave: [
        ...
        "Cómo leer la Biblia: método sencillo paso a paso",
...
export function getEstudioPorNumero(numero: number): PasoEstudio | undefined {
  return ESTUDIOS_BIBLICOS.find((e) => e.numero === numero);
}
